...
const DICT = {
  ...
  en: {
    ...
    'tab.featured':'Signature Tours', 'tab.2d1n':'2 Days 1 Night', 'tab.3d2n':'3 Days 2 Nights', 'tab.4d3n':'4 Days 3 Nights',
  ...
  ja: {
    ...
    'tab.featured':'特選ツアー', 'tab.2d1n':'1泊2日', 'tab.3d2n':'2泊3日', 'tab.4d3n':'3泊4日',
  ...
  ko: {
    ...
    'tab.featured':'대표 투어', 'tab.2d1n':'1박 2일', 'tab.3d2n':'2박 3일', 'tab.4d3n':'3박 4일',
  ...
  'zh-cn': {
    ...
    'tab.featured':'精选主打行程', 'tab.2d1n':'两天一夜', 'tab.3d2n':'三天两夜', 'tab.4d3n':'四天三夜',
