/* ═══ 乞龜幸運遊戲 — 五語系文字字典 ═══
   ...
   語言：zh-tw（繁中，預設）／en／ja／ko／zh-cn
   切換後存 localStorage('qigui_lang')，data-i18n 屬性的元素會自動套用對應文字。
   聯絡管道：2026-09-09 起改回官方 LINE @phbay2018（原 WhatsApp 已停用，勿混用）。 */
...
var QGUI_I18N = {
  'zh-tw': {
    ...
    'footer.legal': '潮旅國際旅行社｜交觀乙第1864號｜品保澎字第0188號｜電話 06-9271288｜LINE @phbay2018',
    'footer.home': '回潮旅官網',
  ...
  'en': {
    ...
    'hero.kicker': 'Amazing Taiwan · Generous Local Gifts · Limited Event',
  ...
  'ja': {
    ...
    'nav.line': '公式LINEを追加',
    'hero.kicker': '輝く台湾・地域の贈り物・限定イベント',
    ...
    'game.lockedHint': '本日のチャレンジは終了。また明日！または <a href="https://line.me/R/ti/p/@phbay2018" target="_blank" rel="noopener noreferrer" style="color:#7dd6ff;font-weight:800">LINEで潮旅に相談</a>して澎湖旅行を計画しよう',
    ...
    'win.codeLabel': '引換番号',
    'win.claimBtn': 'LINEでギフトを受け取る',
    'win.note': '潮旅の公式LINE（@phbay2018）を追加し、<strong>この画面をスクリーンショットして引換番号を送信</strong>してください。<br>ブースで画面をご提示いただくとギフトと交換できます。各番号は1回限り有効。',
    'win.hintDone': 'チャレンジ完了。LINEでギフトをお受け取りください',
    ...
    'footer.legal': '潮旅国際旅行社｜交觀乙第1864號｜品保澎字第0188號｜電話 06-9271288｜LINE @phbay2018',
  ...
  'ko': {
    ...
    'nav.line': '공식 LINE 추가',
    'hero.kicker': '빛나는 대만 · 지역 특산 선물 · 한정 이벤트',
    ...
    'game.lockedHint': '오늘의 도전이 끝났어요. 내일 다시! 아니면 <a href="https://line.me/R/ti/p/@phbay2018" target="_blank" rel="noopener noreferrer" style="color:#7dd6ff;font-weight:800">LINE으로 차오뤼에 문의</a>해 펑후 여행을 계획하세요',
    ...
    'win.codeLabel': '교환 번호',
    'win.claimBtn': 'LINE 추가하고 선물 받기',
    'win.note': '차오뤼 공식 LINE(@phbay2018)을 추가한 뒤 <strong>이 화면을 캡처해 교환 번호를 보내 주세요</strong>.<br>부스에서 화면을 제시하면 선물로 교환해 드립니다. 번호당 1회만 교환 가능.',
    'win.hintDone': '챌린지 완료 — LINE으로 선물을 받아 가세요',
    ...
    'footer.legal': '차오뤼 국제여행사｜交觀乙第1864號｜品保澎字第0188號｜전화 06-9271288｜LINE @phbay2018',
  ...
  'zh-cn': {
    ...
    'culture.ctaLink': '找潮旅安排行程',
    'footer.legal': '潮旅国际旅行社｜交观乙第1864号｜品保澎字第0188号｜电话 06-9271288｜LINE @phbay2018',
    'footer.home': '回潮旅官网',
